...
var _elm_lang$html$Item$ToolOptions = F2(
	function (a, b) {
		return {effect: a, area: b};
	});
		...
		var updateItem = F3(
			function (row, column, item) {
				return A2(
					...
					coordinates) ? A2(_elm_lang$core$Maybe$map, update, item) : item;
			});
		return A2(_tortus$elm_array_2d$Array2D$indexedMap, updateItem, garden);
	});
...
var _elm_lang$html$Seeds$growSeed = function (options) {
	return (_elm_lang$core$Native_Utils.cmp(options.age, options.maturity) < 0) ? _elm_lang$core$Native_Utils.update(
		options,
		{age: options.age + 1}) : options;
};
var _elm_lang$html$Seeds$allSeeds = {
	ctor: '::',
	_0: _elm_lang$html$Seeds$apple,
	_1: {
		ctor: '::',
		_0: _elm_lang$html$Seeds$orange,
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Seeds$banana,
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Seeds$lettuce,
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Seeds$grape,
					_1: {ctor: '[]'}
				}
			}
		}
...
var _elm_lang$html$Inventory$init = A2(
	...
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: _elm_lang$html$Seeds$apple, _1: 10},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _elm_lang$html$Seeds$orange, _1: 5},
			_1: {ctor: '[]'}
		}
	});
...
var _elm_lang$html$Tools$sprinkler = function () {
	var area = function (_p0) {
		...
		return {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _p3 - 1, _1: _p2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: _p3 + 1, _1: _p2},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _p3, _1: _p2 - 1},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _p3, _1: _p2 + 1},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: _p3 - 1, _1: _p2 - 1},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: _p3 + 1, _1: _p2 + 1},
								_1: {
	...
	var effect = function (item) {
		var newOptions = function () {
			var _p4 = item.options;
			if (_p4.ctor === 'Seed') {
				return _elm_lang$html$Item$Seed(
					_elm_lang$html$Seeds$growSeed(_p4._0));
			} else {
				return item.options;
			}
		}();
	...
	var options = _elm_lang$html$Item$Tool(
		{effect: effect, area: area});
	return {name: 'Sprinkler', description: 'Grows all adjacent seeds once every 0.5s', image: 'https://image.flaticon.com/icons/svg/135/135746.svg', cost: 100, options: options};
}();
var _elm_lang$html$Tools$allTools = {
	ctor: '::',
...
var _elm_lang$html$View$renderInventory = function (inventory) {
	...
	return A2(
		_elm_lang$core$List$map,
		stack,
		_eeue56$elm_all_dict$AllDict$toList(inventory));
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				_elm_lang$html$View$renderInventory(model.inventory)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
			...
			case 'Tick':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{time: model.time + 0.5, garden: newGarden}),
...
var _elm_lang$html$Main$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, 500 * _elm_lang$core$Time$millisecond, _elm_lang$html$Messages$Tick);
};
